...
biocLite(pkgs=c("sva","minfi","lumi","wateRmelon","limma","methylumi","Biobase","IRanges","AnnotationDbi",
"IlluminaHumanMethylation450k.db","FDb.InfiniumMethylation.hg19","ChAMP"))'
